...
const levels = [
  ...
  |:#:::||||::#::|
        ...
        Robin needed to shoot The horse-drawn carriage to cut the rope that tied the sack containing the gold coins.What is the initial speed for Robin to fire?
        `,
        correctAngle: 30,
    },
    {
